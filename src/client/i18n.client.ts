...
const en = {
  ...
  "send.project.noWorkspaces": "This Project has no Workspace yet. Create one in Paseo before sending to a new Agent.",
...
const zh: Record<MessageKey, string> = {
  ...
  "send.project.noWorkspaces": "这个 Project 还没有 Workspace。请先在 Paseo 中创建 Workspace，再发送给新 Agent。",
